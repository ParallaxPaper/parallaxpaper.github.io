...
const DATA = {
    ...
    HEAD: {
        ...
        PROJECT_TITLE: "Defense of the Clones: Securing Web Applications with Automatic Honeypot Generation and Deployment",
        PROJECT_SUBTITLE: {
            "name": "eCrime,  2025",
    ...
    LINKS: [
        ...
        },
        {
            ...
            "links": [
                {
                    "name": "Repository",
                    "url": "https://github.com/BillyPragSec/parallaxpaper",
    ...
    CITATION: ` \
    @article{tsouvalas2024defense,
        author    = {Tsouvalas, Billy and Nikiforakis, Nick},
        title     = {Defense of the Clones: Securing Web Applications with Automatic Honeypot Generation and Deployment},
        journal   = {APWG Symposium on Electronic Crime Research (eCrime)},
        year      = {2025}
    }`,
    FOOTER: {
        LOGOS: [
        ...
        COPYRIGHT: `Copyright PragSec Lab 2025`
    },
}
// ===== END CUSTOM DATA =====
